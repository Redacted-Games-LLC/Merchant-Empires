...
?>
<div class="viewport_ship_info align_center">
	<br />
	<div class="sidebar_ship_type align_center">
	...
	<div class="sidebar_ship_name align_center">
		<?php echo $spacegame['player']['ship_name'] == '' ? DEFAULT_SHIP_NAME : $spacegame['player']['ship_name']; ?>
	</div>
	<div class="sidebar_ship_turns align_center">
	...
	<?php if ($spacegame['player']['ship_type'] > 0) { ?>
		...
		<?php if (isset($spacegame['cargo'])) { ?>
			...
			<div class="sidebar_ship_goods align_left">
				&nbsp;
				<?php
					foreach ($spacegame['cargo'] as $id => $cargo) {
						echo '<div class="sidebar_ship_good_row">';
							...
							echo '<div class="sidebar_ship_good_image align_left">';
								echo '<img src="res/goods/' . strtolower(str_replace(' ', '_', $good['caption'])) . '.png" width="20" height="20" />';
							echo '</div>';
							
							echo '<div class="sidebar_ship_good_caption align_left">';
								echo $good['caption'];
							echo '</div>';

							echo '<div class="sidebar_ship_good_amount align_right">';
