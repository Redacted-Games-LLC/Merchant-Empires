...
<div class="docs_text">
	Now fly around to different planets inside the protected perimeter. 
	Click on the <a href="docs.php?page=ports">port</a>, they buy and
	sell goods with an indicator of how far to the nearest places to
	send or receive them. You may wish to scout out the destination to
	make sure it is a safe place before starting a trade route.
</div>
<div class="docs_text">
