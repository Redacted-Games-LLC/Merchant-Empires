...
<div class="docs_text">
	...
	of the viewport shows you whether or not there is hostile forces in the
	adjacent sector. Check your radar before moving, refresh if necessary.
</div>
<div class="docs_text">
...
<div class="docs_text">
	Warps are near the center of the solar system. If we recall back in early celestial
	<a href="docs.php?page=navigation">navigation</a> we were taught about terminators,
	and can tell the position of a star just by looking at one of the planets that
	orbits it:
</div>
<div class="docs_image">
...
<div class="docs_text">
	...
	warps near the stars but the warp we actually needed is out by itself:
</div>
<div class="docs_image">
	<img src="res/doc/finding_warps.png" alt="Planet shadow" title="The shadow on the planet shows which direction to the star." />
</div>
<div class="docs_text">
	Passing through the warp we come face to face with a return warp for a different system.
	<strong>WARNING:</strong> warps are unidirectional, that is they are one-way only.
	If you accidentally warp and find yourself facing another warp it may <em>not</em> take
	you where you want to go. In this case the apparent return warp would actually take us
	to Xollian Prime:
</div>
<div class="docs_image">
...
<div class="docs_text">
	We want to make sure we know to find the proper warp to return from. The good news is that
...
<div class="docs_text">
	...
	told there are no traders. This could only mean the supplier is further from this port
...
<div class="docs_text">
	...
	sale it would have been a good deal so close to that other demand.
</div>
<div class="docs_text">
	Our next step will be take the warps from Xoll-Mawl and try to find our good in one of
	those systems. It doesn't take long to find out the Xollian Prime system had what we
	were looking for:
</div>
<div class="docs_image">
