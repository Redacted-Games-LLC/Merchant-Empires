...
$RETURN_CODES = array(
	...
	1062 => 'You have levelled up your player but the next rank requires a higher level. Keep gaining levels for rank promotion!',
	1063 => 'You have levelled up your player but the next rank requires a higher alignment. Keep gaining alignment for rank promotion!',
	...
	1180 => 'You have too many recent failures. Try again shortly.',
	1181 => 'Form submission did not originate from a validated source.',
	1182 => 'You did not pass the coordinate test.',
	1183 => 'You must be in a ship to do that.',
	1184 => 'There is a limit of ' . WEAPON_SOLUTION_LIMIT . ' solution(s).',
	1185 => 'You are not carrying any weapons to add.',
	1186 => 'You must specify a valid weapon to add.',
	1187 => 'Not enough empty racks or stations to add a weapon to any solution.',
	1188 => 'The weapon race does not match the ship race.',
	1189 => 'Invalid or unknown solution or solution group.',
	1190 => 'Invalid or missing direction for moving the weapon.',
	1191 => 'The weapon has been repositioned.',
	1192 => 'The weapon has been removed and placed in your cargo holds',
	1193 => 'The weapon has been added to the solution.',
	1194 => 'You cannot engage in ship to ship combat under level ' . MINIMUM_KILLABLE_LEVEL . '.',
	1195 => 'You cannot engage in combat with an escape pod.',
	1196 => 'You are hitting the fire button too quickly. Please slow down.',
	1197 => 'You must select a target for the attack.',
	1198 => 'You cannot select multiple targets in a single attack.',
	1200 => 'Player or force not in range for attack.',
	1201 => 'You are not authorized to land on that base.',
	1202 => 'Your alignment and level increase have earned you a promotion. Congratulations sir.',
	1203 => 'No weapons fired. Check ammunition levels.',
	1204 => 'Target hit for ' . (isset($_REQUEST['amt']) ? number_format($_REQUEST['amt']) : 0) . ' damage.',
	1205 => (isset($_REQUEST['amt']) ? number_format($_REQUEST['amt']) : 0) . ' force(s) hit.',
	1206 => 'You have replenished your shields/armor.',
	1207 => 'That player has a low attack rating and their alignment is in good standing. You cannot attack in a protected system.',
	1208 => 'While in protected systems you have to must have an attack rating of ' . SAFE_ATTACK_RATING_LIMIT . ' or higher to engage in ship to ship combat.',
	1209 => 'No ships found in the database. You must have the starter ships available.',
	1210 => 'Warps failed to completely insert.',
	1211 => 'Galaxy appears to have been generated and is ready to use.',
